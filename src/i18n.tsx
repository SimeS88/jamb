...
const dict = {
  hr: {
    ...
    rules: 'Pravila',
    rulesText:
      'Igra se sa 6 kockica, u svakom polju boduje se najviše 5. U svakom potezu imaš do 3 bacanja; kockice koje zadržiš se ne bacaju ponovno. Stupci: Dolje (odozgo), Gore (odozdo), Slobodno (bilo koji red) i Najava (red moraš najaviti odmah nakon prvog bacanja). Bonus +30 ako je zbroj brojeva ≥ 60. Tris = tri iste (3 × broj + 10). Kenta vrijedi 35 (1–5) ili 45 (2–6). U igri s dva igrača vrijedi protunajava: kad protivnik odigra najavu, ti u sljedećem potezu moraš odigrati isto polje u svom stupcu najave.',
    loading: 'Učitavanje…',
    menu: 'Izbornik',
  ...
  en: {
    ...
    rules: 'Rules',
    rulesText:
      'Played with 6 dice; at most 5 count in each field. Each turn allows up to 3 rolls; held dice are not re-rolled. Columns: Down (top to bottom), Up (bottom to top), Free (any order) and Announce (you must announce a row right after the first roll). Bonus +30 if the number section sums to 60 or more. Three of a kind = 3 × value + 10. Straight scores 35 (1–5) or 45 (2–6). In two-player games the counter-announcement applies: when your opponent plays an announcement, your next move must be the same field in your own announce column.',
    loading: 'Loading…',
    menu: 'Menu',
